...
namespace STrans.Service.ModesCentre
{
    class ParseMCGetData : IDisposable
    {
        ...
        private StatisticTrans.Contract.ModesCentre.Operation _operation;
        ...
        {
            _operation = StatisticTrans.Contract.ModesCentre.Operation.Unknown;
            ...
            Enum.TryParse<StatisticTrans.Contract.ModesCentre.Operation> (_arguments [0], out _operation);
        }
        ...
        public bool Result(DataTable table)
        {
            ...
            switch (_operation) {
                case StatisticTrans.Contract.ModesCentre.Operation.InitIGO:
                    bRes = fInitIGO (table);
                    break;
                case StatisticTrans.Contract.ModesCentre.Operation.MaketEquipment:
                    bRes = fMaketEquipment (table, _arguments [1].Split (','), DateTime.FromOADate (Double.Parse (_arguments [2])));
                    break;
                case StatisticTrans.Contract.ModesCentre.Operation.PPBR:
